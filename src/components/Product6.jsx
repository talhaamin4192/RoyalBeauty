    ...
    <div className='font-roboto'>
      ...
      <div className='px-22 h-[25vh] relative bg-sec '>
        ...
        <div className='border-t-1 border-cstm-border z-40'>
          ...
          <p>Nano Strokes is a modern eyebrow enhancement technique similar to microblading but uses an even finer needle. In nano-stroking, tiny, precise strokes are created with a handheld tool that implants pigment into the skin, mimicking the appearance of natural eyebrow hairs. The ultra-fine needle allows for greater detail and precision, resulting in a more refined and realistic look. This technique is particularly suitable for individuals with sparse or over-plucked eyebrows, as it can create a fuller and more defined brow appearance with subtle, feather-like strokes. Nano-stroking provides a semi-permanent solution to enhance eyebrow shape and density, offering a natural and long-lasting result.</p>
        </div>
      </div>
      <Related></Related>
      <Footer></Footer>
