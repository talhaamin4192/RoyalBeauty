    ...
    <div className='font-roboto'>
      ...
      <div className='grid grid-cols-2 h-[150vh] w-full bg-sec px-22 gap-10 py-10'>
        <div>
          ...
          <div className='flex'>
          <img src={Item4} className='size-34' alt="" />
          <img src={Itemx}  className='size-34 opacity-50 hover:opacity-100
          transition-all duration-200 ease-in ' alt="" />
          </div>
        </div>
        <div>
          <div className='flex flex-col gap-5'>
            ...
            <p>
            Dark Lip Neutralization is a semi-permanent treatment to lighten and balance dark lips for a natural, even tone.
            </p>
      ...
      <div className='px-22 h-max relative bg-sec '>
        ...
        <div className='border-t-1 border-cstm-border z-40'>
          ...
          <p>Dark Lip Neutralization is a semi-permanent treatment that helps lighten and balance the tone of naturally darker lips. A specialized pigment is used to create a softer, more even color, enhancing the natural look of your lips.
          </p>
          <p>
          With proper care after the treatment, results can last 2–3 years, giving you a long-lasting, natural enhancement to your lip tone.
          </p>
        </div>
      </div>
      <Related></Related>
